...
EnqPage.create([{:enq_id => 1, :page_id => 1, :face => 'iOS', :description => 'iOSです1', :interval => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 1, :page_id => 2, :face => 'iOS', :description => 'iOSです2', :interval => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 2, :page_id => 3, :face => 'PC', :description => 'PCです1', :interval => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 2, :page_id => 4, :face => 'PC', :description => 'PCです2', :interval => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 3, :page_id => 5, :face => 'Android', :description => 'Androidです1', :interval => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 3, :page_id => 6, :face => 'Android', :description => 'Androidです2', :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				{:enq_id => 3, :page_id => 7, :face => 'Android', :description => 'Androidです3', :interval => 5},
				{:enq_id => 4, :page_id => 8, :face => 'iOS', :update_name => '石川', :update_date => '2012-05-29 12:00:00'}])
				
EnqQuestion.create([{:enq_id => 1, :no => 1, :question_id => 1, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
					{:enq_id => 2, :no => 2, :question_id => 2, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
					{:enq_id => 3, :no => 3, :question_id => 4, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
					{:enq_id => 4, :no => 4, :question_id => 3, :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
					{:enq_id => 2, :no => 5, :question_id => 5, :update_name => '石川', :update_date => '2012-05-29 12:00:00'}])
...
Answer.create([{:enq_id => 1, :no => 1, :answer => '回答1', :update_name => '石川', :update_date => '2012-05-29 12:00:00'},
				...
				{:enq_id => 3, :no => 5, :answer => '回答5', :update_name => '石川', :update_date => '2012-05-29 12:00:00'}])
