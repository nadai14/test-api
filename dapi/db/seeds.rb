...
q5 = Question.create(kind: 'select', title: '朝スッキリサプリ!!　オルニチンに興味がありますか？', required: true)
q6 = Question.create(kind: 'select', title: '朝スッキリサプリ！！オルニチン　半額キャンペーン ＋ mixiポイントプレゼントに申し込みたいですか？', required: true)
