...
campaign = Campaign.create(mid: '28080715-38D2-432A-8B7A-C08454E4BE0B', enq_id: enq.uuid, status: 1, platform: 'mixi', point: 10, movie: 'http://moviereward.nadai.jp/video/plus1/plus1.mp4',
                           thumbnail: '/css/sp/themes/plus1/thumbnail.jpg', message: '', conversion_tag: '<img src=\'//moviereward.nadai.jp/images/plus1/conversion-sp.jpg?adv_key=#{uid}&t=#{time}\' />', second_picture: '/css/sp/themes/plus1/2nd_banne.png', client_url: 'http://www.p1-intl.com/')
...
campaign = Campaign.create(mid: '2F8E144A-7AB8-49D9-A49A-02D907A83ACC', enq_id: enq.uuid, status: 1, platform: 'gree', point: 10, movie: 'http://moviereward.nadai.jp/video/lgmx/lgmx.flv',
                           thumbnail: '/css/sp/themes/lgmx/thumbnail.jpg', message: '', conversion_tag: '<img src=\'//moviereward.nadai.jp/images/lgmx/conversion-sp.jpg?adv_key=#{uid}&t=#{time}\' />', second_picture: '/css/sp/themes/lgmx/2nd_banne.png', client_url: 'http://www.exabody.jp/smp-lp/lgmx/?af_id=262&s_ma=90WDRM01_md15_m1')
...
campaign = Campaign.create(mid: 'D75D30FA-0B6F-4800-A8BF-DFDCADD527AF', enq_id: enq.uuid, status: 1, platform: 'gree', point: 10, movie: 'http://moviereward.nadai.jp/video/nagatanien/nagatanien.mp4',
                           thumbnail: '/css/sp/themes/nagatanien/thumbnail.jpg', message: '', conversion_tag: '<img src=\'//moviereward.nadai.jp/images/nagatanien/conversion-sp.jpg?adv_key=#{uid}&t=#{time}\' />', second_picture: '/css/sp/themes/nagatanien/2nd-banner.png', client_url: 'http://poncan.jp')
